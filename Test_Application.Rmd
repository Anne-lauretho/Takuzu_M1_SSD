...
server <- function(input, output, session) {
  game_data <- reactiveVal()  # Stocke les données de la grille
          ...
          lapply(1:6, function(row) {
            lapply(1:6, function(col) {
              ...
              button_style <- if (is_fixed) {
                "background-color: #add8e6; width: 100%; aspect-ratio: 1 / 1; font-size: 16px;"
              } else {
...
Le code me met bien l'interface de base, cependant il m'affiche que la grille et pas le reste.
